...
set CommonLinkerFlags= -incremental:no -opt:ref -LIBPATH:C:\C++Projects\Projects\Client-Server_RealTime\Libraries\soil\Simple_OpenGL_Image_Library\projects\VC9\x64\Release SOIL.lib -LIBPATH:C:\C++Projects\Projects\Client-Server_RealTime\Libraries\glfw-3.3.bin.WIN64\lib-vc2017 glfw3.lib -LIBPATH:C:\C++Projects\Projects\Client-Server_RealTime\Libraries\glew-2.1.0-win32\glew-2.1.0\lib\Release\x64 glew32.lib opengl32.lib kernel32.lib shell32.lib gdi32.lib user32.lib Ws2_32.lib
